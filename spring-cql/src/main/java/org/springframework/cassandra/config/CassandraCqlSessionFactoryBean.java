...
public class CassandraCqlSessionFactoryBean
	...
	/**
	 * Sets the name of the Cassandra Keyspace to connect to. Passing <code>null</code>, an empty String, or whitespace
	 * will cause the Cassandra System Keyspace to be used.
	 *
